...
| Reference-inhibitor docking (screening protocol, 24 Å box, ex 8) | CHEMBL418376 (1.0 µM **vs SMPD2**): **-8.00**; CHEMBL5284579 (1.8 µM vs SMPD2): **-8.00**; CHEMBL310981 (1.0–3.3 µM vs SMPD2; 49 µM vs human SMPD1): **-8.00** kcal/mol — **reference identity corrected after external audit; the µM anchors are NOT verified human-SMPD1 actives** |
