...
| Simulation/triage (G4) | 3,642 scored; 1,158 ≤ −7.0; apo MD 5.81 ns; bound MD v1 (6.1 ns, Li-2013 12-6) **audited & corrected**; bound MD v2 (3.0 ns, 12-6 subset of 12-6-4, C4 omitted, pre-registered): **no Zn coordination (5.6–6.6 Å), pocket occupancy 0%, contacts on non-catalytic surface (235/342/374/375/376/405)**. **FAIL-as-submitted (units/selection); corrected analyses adopted** | G4: FAIL→corrected |
