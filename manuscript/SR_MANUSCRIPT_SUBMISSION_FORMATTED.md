...
Code, compact project-generated data, audit records, development benchmarks, figures, and manuscript sources are available at https://github.com/Gnimi114514/audited-agentic-drug-discovery-smpd1 (release `v0.1.0`). Multi-gigabyte molecular-dynamics trajectories and third-party datasets are not hosted on GitHub; their identities, checksums, and scope are documented in the repository. No wet-laboratory data were generated. Code is licensed under the MIT License, while original text, figures, and project-generated data are licensed under CC BY 4.0. The repository was accessed on 18 September 2026.
