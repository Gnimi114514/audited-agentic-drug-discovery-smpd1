...
The local submission package contains the scripts, raw data, computed results, trajectories, audit reports, frozen manifests, and decision trail. A versioned public deposit with a persistent identifier will be completed before submission and inserted into the manuscript's Data Availability statement.
